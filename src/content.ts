...
import { injectLoadBearingFiles, cleanupLoadBearingFiles } from "./features/load-bearing-files";
...
const FEATURE_CLASSES: Record<FeatureKey, string[]> = {
  ...
  "feature-load-bearing-files": ["better-github-load-bearing"],
};
...
const FEATURE_CLEANUPS: Partial<Record<FeatureKey, () => void>> = {
  ...
  "feature-load-bearing-files": cleanupLoadBearingFiles,
};
...
function injectFeature(key: FeatureKey): void {
  switch (key) {
    ...
    case "feature-pr-collapse-expand":
      ...
      break;
    case "feature-load-bearing-files":
