...
const marquee = `<svg xmlns="http://www.w3.org/2000/svg" width="1400" height="1400" viewBox="0 0 1400 1400">
  ...
  <g font-family="${FONT}">
    ...
    <text x="354" y="${752}" font-size="34" font-weight="400" fill="#c1d4cf">See the details that matter, right on GitHub.</text>
    <rect x="356" y="${787}" width="116" height="6" rx="3" fill="#3fb950"/>
  </g>
</svg>`;
...
const small = `<svg xmlns="http://www.w3.org/2000/svg" width="440" height="440" viewBox="0 0 440 440">
  ...
  <g font-family="${FONT}" text-anchor="middle">
    ...
    <text x="220" y="${328}" font-size="16" font-weight="400" fill="#c1d4cf">Clearer pull requests and repos</text>
  </g>
</svg>`;
